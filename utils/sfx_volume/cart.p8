...
sfxstart[-sfxend],delta,src,[dest] - transpose sfx:\
...
--parse param_str
local range, delta, src, dest = unpack(split(PARAM_STR))
...
assert(delta, "delta must be a number\n" .. MESSAGES.GET_HELP)
...
sfx_volume(delta, sfxstart, sfxend)
